...
<link href="<c:url value='/resources/css/productDetail.css'/>" rel="stylesheet" />
<link>
</head>
<body>
<div class="container">
<form:form action="productDetail" method="post" modelAttribute="product" >
<div class="card">
	<div class="row">
...
<dl class="item-property">
  <dt>Description</dt>
  <dd><p>This is the description field</p></dd>
</dl>
<hr>
	<div class="row">
		<div class="col-sm-12">
